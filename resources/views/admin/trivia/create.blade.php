...
<div class="container mt-4">
    ...
    <div class="card shadow-sm">
        <div class="card-body">
            <form id="trivia-form" action="{{ route('admin.trivia.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="d-flex justify-content-center gap-3 mt-4">
                    ...
                    <a href="{{ route('admin.trivia.index') }}" class="btn btn-danger px-4">
...
function validateOptions() {
    ...
    if (hasDuplicate) {
        Swal.fire({ icon: 'warning', title: 'Duplicate Option!', text: 'Duplicate options are not allowed.' });
    }
...
function confirmSubmission() {
    ...
    if (category === "") {
        Swal.fire({ icon: 'error', title: 'Missing Category', text: 'Please select a category before submitting.' });
        return;
    }
    ...
    if (correctAnswer === "") {
        Swal.fire({ icon: 'error', title: 'Missing Correct Answer', text: 'Please select a correct answer before submitting.' });
        return;
    }
